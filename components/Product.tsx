...
export const Product = ({product, hasAnimation=true, fullWidth=false}:{product:IProduct, hasAnimation?: boolean, fullWidth?:boolean}) => {
    ...
    return (
        <div className={styles.container} style={{
            width: fullWidth ? "100%" : PRODUCT_CARD.cardWidth
        }}>
            <img 
